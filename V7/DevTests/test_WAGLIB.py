...
# Set a WAGENINGEN foil - without smoothing
foil=WAGENINGEN(Z=4,EAR=1,rR=0.2,tLE_tmax=0.2,Smooth_LE=0,x0s=0.1,x0p=0.1,ks=0.5,kp=0.5)#
# Set a WAGENINGEN foil - with smoothing
#foil=WAGENINGEN(Z=4,EAR=1,rR=0.2,tLE_tmax=0.2,Smooth_LE=1,x0s=0.1,x0p=0.1,ks=0.5,kp=0.5)#
