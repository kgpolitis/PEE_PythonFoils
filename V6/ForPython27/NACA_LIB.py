...
class NACArep(foil):
    ...
    def vecS_TE(self):
        ...
        return [vec_PresSide_TEtoLEx.astype(float), vec_PresSide_TEtoLEy.astype(float), vec_SuctSide_TEtoWkx.astype(float), vec_SuctSide_TEtoWky.astype(float)]
    ...
    def vecS_LE(self):
        ...
        vx=-dyc/lv
        vy=1/lv
        return [vx.astype(float),vy.astype(float),vx.astype(float),vy.astype(float)]
